...
public class MemberListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			 ...
			 * res.setContentType("text/html;charset=UTF-8"); rd.include(req, res);
			 */
			 ...
			 *  e.printStackTrace();
			 * req.setAttribute("error", e); RequestDispatcher rd =
			 * req.getRequestDispatcher("/Error.jsp"); rd.forward(req, res);
			 */
		}
	}
